...
use Application\Sonata\ProductBundle\Entity\Tile;
 ...
 */
class TileProductProvider extends GenericProductProvider
{
    /**
     * {@inheritDoc}
     */
    ...
    {
    	dump();
    	return 'SonataProductBundle:Tile';
    }
    ...
    public function buildEditForm(FormMapper $formMapper, $isVariation = false)
    {
    	...
    	if ($isVariation) {
    		$formMapper->with('Variant')
    		->add('size', 'choice', array(
    				'choices'            => Tile::getSizeList(),
