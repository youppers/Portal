...
use Youppers\CompanyBundle\Form\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('YouppersCompanyBundle:Brand')->findAll();
     ...
     * @Method("POST")
     * @Template("YouppersCompanyBundle:Brand:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('YouppersCompanyBundle:Brand')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("YouppersCompanyBundle:Brand:edit.html.twig")
     */
