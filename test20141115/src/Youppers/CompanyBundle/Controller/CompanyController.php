...
use Youppers\CompanyBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('YouppersCompanyBundle:Company')->findAll();
     ...
     * @Method("POST")
     * @Template("YouppersCompanyBundle:Company:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('YouppersCompanyBundle:Company')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("YouppersCompanyBundle:Company:edit.html.twig")
     */
